    ...
    <div className="min-h-screen bg-[#020617] text-slate-200 selection:bg-emerald-500/30 overflow-hidden relative font-sans">
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 pt-20 pb-32 flex flex-col items-center text-center">
        ...
        <p className="text-lg md:text-xl mb-12 text-slate-400 font-normal max-w-2xl leading-relaxed">
          Создайте мгновенную комнату одним кликом. Никаких регистраций, 
          установок и паролей. Просто отправьте ссылку и начните общение.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-32 w-full">
          <div className="bg-white/5 border border-white/10 p-8 rounded-3xl text-left backdrop-blur-sm hover:border-blue-500/30 transition-colors group">
            ...
            <h3 className="text-white font-bold text-xl mb-3">Приватно</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
              Ваши звонки защищены сквозным шифрованием WebRTC. Данные не проходят через наши серверы.
            </p>
          </div>
          <div className="bg-white/5 border border-white/10 p-8 rounded-3xl text-left backdrop-blur-sm hover:border-emerald-500/30 transition-colors group">
            ...
            <h3 className="text-white font-bold text-xl mb-3">Мгновенно</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
              Никаких форм и подтверждений почты. Один клик и вы в эфире. Самый быстрый способ позвонить.
            </p>
          </div>
          <div className="bg-white/5 border border-white/10 p-8 rounded-3xl text-left backdrop-blur-sm hover:border-teal-500/30 transition-colors group">
            ...
            <h3 className="text-white font-bold text-xl mb-3">Любое устройство</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
              Работает в любом современном браузере на iOS, Android, macOS и Windows. Без установки.
            </p>
          </div>
        </div>
      </main>
