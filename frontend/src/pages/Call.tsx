...
export const Call: React.FC = () => {
  ...
  useEffect(() => {
    document.title = 'Создать звонок — TalkLink'
  }, [])
        ...
        <main>
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-5xl font-black text-white mb-6 tracking-tight leading-tight">
              Создайте вашу <br />
              <span className="text-blue-500">приватную комнату</span>
            </h1>
            <p className="text-slate-400 text-lg mb-10 leading-relaxed">
              Нажмите кнопку ниже, чтобы мгновенно сгенерировать уникальную ссылку. 
              Никаких данных не сохраняется на сервере.
            </p>
          </div>
            ...
            {!roomUrl ? (
              <div className="flex flex-col items-center py-8">
                ...
                <p className="mt-8 text-slate-500 text-sm font-medium flex items-center gap-2">
                  ...
                  Защищено WebRTC Encryption
                </p>
              </div>
            ) : (
              <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div>
                  <h2 className="text-xs font-black uppercase tracking-[0.2em] text-blue-400 mb-4">Ссылка доступа</h2>
          ...
          <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-12">
            {[
              { step: '01', title: 'Отправьте ссылку', desc: 'Скопируйте URL и отправьте собеседнику через любой мессенджер.' },
              { step: '02', title: 'Дайте доступ', desc: 'Браузер запросит разрешение на использование камеры и микрофона.' },
              { step: '03', title: 'Общайтесь', desc: 'Соединение установится автоматически напрямую между вами.' }
            ].map((item, idx) => (
